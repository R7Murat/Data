...
DATABASES = {
    'default': {
        'ENGINE': 'finaldbblog.cra4ioeq8ymy.us-east-1.rds.amazonaws.com',
        'NAME': 'blog', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': config('PASSWORD'),
        'HOST': 'fp-database.cra4ioeq8ymy.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'fp-web-srv' # please enter your s3 bucket name
